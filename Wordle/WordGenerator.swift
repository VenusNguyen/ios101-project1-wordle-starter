...
class WordGenerator {
  ...
  static let possibleWords = ["JAPAN", "FRUIT", "MARCH", "FIRST", "GUIDE", "CLASS", "WHITE", "BLACK", "APPLE", "BRAVE", "CHAIR", "DREAM", "EAGLE", "FROST", "GRACE", "HAPPY", "ITALY", "JELLY", "KOALA", "LIGHT", "MANGO", "NORTH", "OCEAN", "PARTY", "QUEEN", "RIVER", "STORM", "TIGER", "UNITE", "VENUS"]
